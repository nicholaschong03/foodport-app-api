...
urlpatterns = [
    ...
    path("postcomment/<int:post_id>/comments/", views.ListPostCommentView.as_view(), name="postcomment-list"),
    path("postcomment/<int:pk>/delete/", views.DeleteCommentView.as_view(), name="postcomment-delete"),
