...
urlpatterns = [
    ...
    path("businesses/venture-day/", views.BusinessListView.as_view(), name = 'business_list'),
    path('businesses/<int:id>/', views.RetrieveBusinessView.as_view(), name='retrieve_business'),
    path("businesses/", views.AllBusinessesListView.as_view(), name="retrieve_all_business"),
